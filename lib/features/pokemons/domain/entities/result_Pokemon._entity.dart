...
class ResultPokemonEntity extends Equatable {
  ...
  ResultPokemonEntity.fromJson(Map<String, dynamic> json) {
...
class Forms {
  ...
  Forms.fromJson(Map<String, dynamic> json) {
    name = json['front_default'];
    url = json['front_female'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['front_default'] = this.name;
    data['front_female'] = this.url;
    return data;
  }
}
